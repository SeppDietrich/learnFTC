...
@Autonomous(name="FrontPixelDreaptaRedWithEncoders")

public class FrontPixelDreaptaRedWithEncoders extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            while (leftMotor.getCurrentPosition() < startPos + 2700) {
