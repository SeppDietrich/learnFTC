...
@Autonomous(name="FrontPixelDreaptaBlueWithEncoders")

public class FrontPixelDreaptaBlueWithEncoders extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            while (leftMotor.getCurrentPosition() > startPos - 1700) {
